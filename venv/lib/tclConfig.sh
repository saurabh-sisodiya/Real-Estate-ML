...
# installed.
TCL_PREFIX='/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1699201836711/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -L/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/include'
...
# compiled.
TCL_SRC_DIR='/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/saurabhsisodiya/Downloads/RealEstateMLProject/venv/lib/libtclstub8.6.a'
